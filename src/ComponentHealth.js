...
const ComponentHealth = ({ onComponentClick }) => {
    const components = [
        { id: 'esp32', name: "ESP32-S3 Microcontroller", health: 98, voltage: "3.32V", uptime: "142h", icon: "📟" },
        { id: 'pump', name: "Hydraulic Pump v2", health: 94, voltage: "12.1V", uptime: "88h", icon: "🌀" },
        { id: 'sensor', name: "DS18B20 Temp Probe", health: 100, voltage: "4.98V", uptime: "1052h", icon: "🌡️" },
        { id: 'block', name: "Direct-to-Chip Cold Plate", health: 99, voltage: "N/A", uptime: "210h", icon: "🔳" }
    ];
